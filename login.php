<?php
    ...
    if (Input::get('submit')) {
        Session::set('nip', Input::get('nip'));
        header('Location: index.php');
        if ($siswa->login_user(Input::get('nip'), Input::get('password') ) ) {
            Session:set('nip', Input::get('nip'));
            header('Location: index.php');
        }else{
        ...
        <div class="card border-grey border-lighten-3 m-0">
            ...
            <div class="card-body collapse in">
                <div class="card-block">
                    <form class="form-horizontal form-simple" methods="POST" action="" novalidate>
                        <fieldset class="form-group position-relative has-icon-left mb-0">
                            <input type="text" class="form-control form-control-lg input-lg" id="user-name" name="nip" placeholder="Masukan NIP" required>
                            <div class="form-control-position">
                                <i class="icon-head"></i>
                            </div>
                        </fieldset>
                        <fieldset class="form-group position-relative has-icon-left">
                            <input type="password" class="form-control form-control-lg input-lg" name="password" id="user-password" placeholder="Password" required>
                            <div class="form-control-position">
                                <i class="icon-key3"></i>
                            </div>
                        </fieldset>
                        ...
                        <input type="submit" name="submit" class="btn btn-primary btn-lg btn-block" value="Masuk Sekarang">
                    </form>
                </div>
            </div>
